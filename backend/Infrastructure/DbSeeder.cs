...
public static class DbSeeder
{
    public static void Seed(SubastaYaDbContext context)
    {
        ...
        var activaEstandar = new Subasta
        {
            ...
            UrlImagen = "https://commons.wikimedia.org/wiki/Special:FilePath/Gaming_computers_(1).jpg",
            PrecioBase = 40000m,
        ...
        var activaCritica = new Subasta
        {
            ...
            UrlImagen = "https://commons.wikimedia.org/wiki/Special:FilePath/WWF_HASBRO_ACTION_FIGURES.jpg",
            PrecioBase = 50000m,
        ...
        var proxima = new Subasta
        {
            ...
            UrlImagen = "https://commons.wikimedia.org/wiki/Special:FilePath/Leather_jacket.jpg",
            PrecioBase = 30000m,
            IncrementoMinimo = 1000m,
        ...
        var vencidaConGanador = new Subasta
        {
            ...
            UrlImagen = "https://commons.wikimedia.org/wiki/Special:FilePath/Mountain_bike.JPG",
            PrecioBase = 80000m,
        ...
        var vencidaDesierta = new Subasta
        {
            ...
            UrlImagen = "https://commons.wikimedia.org/wiki/Special:FilePath/Keychron_K8_Non-Backlight_Wireless_Mechanical_Keyboard.jpg",
            PrecioBase = 20000m,
            IncrementoMinimo = 1000m,
