...
public class LiquidarSubastaCommandHandlerTests
{
    ...
    private static (LiquidarSubastaCommandHandler handler, Mock<ISubastaRepository> subastaRepo, Mock<IBilleteraRepository> billeteraRepo)
        CrearHandler()
    {
        ...
        var handler = new LiquidarSubastaCommandHandler(subastaRepo.Object, billeteraRepo.Object, unitOfWork.Object);
        return (handler, subastaRepo, billeteraRepo);
    }

    [Fact]
    public async Task Liquidar_ConGanador_TransfiereElSaldoYFinalizaLaSubasta()
    {
    ...
    [Fact]
    public async Task Liquidar_SinOfertas_MarcaLaSubastaComoDesierta()
    {
        var (handler, subastaRepo, billeteraRepo) = CrearHandler();
